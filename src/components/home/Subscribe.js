                ...
                <Col className="subscribe__col" md={4} xs={5}>
                    ...
                    <Row className="justify-content-md-center">
                        <Form inline onSubmit={handleSubmit(onSubmit)}>
                            <Form.Group>
                                <Form.Control className="subscribe__form--input" name="email" placeholder="Enter your email.." ref={register} />
                            </Form.Group>
                            <Button className="subscribe__button" type="submit">Submit</Button>
                            <ModalSub show={modalShow} onHide={() => setModalShow(false)} />
                        </Form>
                    </Row>
                    <Col className="subscribe__col--error">
                        {errors.email && <ErrorMessageSub>{errors.email.message}</ErrorMessageSub>}
                    </Col>
                </Col>
            </Row>
        </Container>
