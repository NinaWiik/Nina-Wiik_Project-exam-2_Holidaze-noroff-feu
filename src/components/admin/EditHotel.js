                        ...
                        <Form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <Form.Row>
                                <Form.Group as={Col}>
                                    ...
                                    <Form.Control name="maxGuests" defaultValue={hotel.maxGuests} placeholder="Enter max guests" ref={register} />
                            ...
                            <Form.Row>
                                <Form.Group as={Col}>
                                    ...
                                    <Form.Control name="lat" defaultValue={hotel.lat} placeholder="Enter latitude" ref={register} />
                                    {errors.lat && <ErrorMessage>{errors.lat.message}</ErrorMessage>}
                                </Form.Group>

                                <Form.Group as={Col}>
                                    <Form.Label>Longitude</Form.Label>
                                    <Form.Control name="lng" defaultValue={hotel.lng} placeholder="Enter longitude" ref={register} />
                            ...
                            <Form.Group>
                                ...
                                <Form.Control name="image" defaultValue={hotel.image} placeholder="Enter a image URL" ref={register} />
                                {errors.image && <ErrorMessage>{errors.image.message}</ErrorMessage>}
                            </Form.Group>

                            <Form.Group>
                                <Form.Label>Description</Form.Label>
                                <Form.Control as="textarea" rows="3" name="description" defaultValue={hotel.description} placeholder="Enter a description" ref={register} />
